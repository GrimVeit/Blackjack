...
public class PseudoChipModel
{
    ...
    public PseudoChipModel(IMoneyProvider moneyProvider, IBetProvider betProvider, ISoundProvider soundProvider)
    {
    ...
    public void GrabPseudoChip(PseudoChip pseudoChip)
    {
        ...
        if (moneyProvider.CanAfford(pseudoChip.ChipData.Nominal) && betProvider.IsAvailable(pseudoChip.ChipData.Nominal))
        {
